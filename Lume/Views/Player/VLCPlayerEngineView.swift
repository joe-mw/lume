import SwiftUI
    ...
    /// Fallback view used when the VLCKit Swift Package isn't linked into the
    ...
    struct VLCPlayerEngineView: View {
        ...
        var body: some View {
            VStack(spacing: 16) {
                ...
                Text("VLCKit not installed")
                    .font(.title3.weight(.semibold))
                    .foregroundStyle(.white)

                Text("Add the vlckit-spm Swift Package, or switch to another engine in Settings → Player.")
                    .font(.callout)
